...
tiff("figures/fig3_revised.tif", units = "in", width=11.69, height=8.27, res= 300, compression = "lzw")
final+inset_element(WGS_map, left=0, bottom=0.5, right=0.5, top=1,align_to = "full")
dev.off()

pdf("figures/fig3_revised.pdf", width=11.69, height=8.27)
final+inset_element(WGS_map, left=0, bottom=0.5, right=0.5, top=1,align_to = "full")
dev.off()

jpeg("figures/fig3_revised.jpg", quality=500, width=11.69, height=8.27, units="in", res=200)
final+inset_element(WGS_map, left=0, bottom=0.5, right=0.5, top=1,align_to = "full")
dev.off()
